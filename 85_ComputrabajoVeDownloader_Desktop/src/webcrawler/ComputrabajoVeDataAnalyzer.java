...
/**
*/
public class ComputrabajoVeDataAnalyzer {
    ...
    */
    ...
    private static void processProfilePictureUrl(DBObject o, String id, int i) {
        try {
            ...
            Logger.getLogger(ComputrabajoVeDataAnalyzer.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private static void downloadImage(String url, String filename) 
    {
        ...
        try {
            ...
            Logger.getLogger(ComputrabajoVeDataAnalyzer.class.getName()).
